...
public:
  ...
  // interaction
  QCheckBox *hoverMarkRead_;
  QComboBox *hoverMarkDelay_;
  QCheckBox *scrollMarkRead_;
  QCheckBox *viewportMarkRead_;
  QCheckBox *markExcludeOnlyStarred_;
  QLineEdit *excludedGroups_;
  QLineEdit *excludedFeeds_;
  QPushButton *undoMarkButton_;

  // cleanup
  QCheckBox *cleanupEnabled_;
  QRadioButton *cleanupStrategyTime_;
  QRadioButton *cleanupStrategyCount_;
  ...
  QComboBox *aiProvider_;
  QLineEdit *aiApiKey_;
  QLineEdit *aiBaseUrl_;
  QComboBox *aiModel_;
  QSpinBox *aiSummaryLength_;
  QComboBox *aiHistoryRetention_;
  QCheckBox *aiOfflineCache_;
  QCheckBox *aiAutoTranslate_;
  QComboBox *aiTranslateLang_;
  QComboBox *aiTranslationEngine_;
  QLineEdit *aiDeeplKey_;
  QLineEdit *aiBaiduAppId_;
  QLineEdit *aiBaiduKey_;
