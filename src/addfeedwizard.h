...
private:
  ...
  QComboBox *fetchTypeCombo_;
  QPlainTextEdit *xpathRuleEdit_;
  QLabel *xpathHintLabel_;
  LineEdit *scriptPathEdit_;
  QLabel *scriptHintLabel_;
