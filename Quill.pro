...
HEADERS += \
    ...
    src/feedsview/intelligentrefreshcalculator.h \
    src/VersionRev.h \
    ...
    src/newsview/interactivemark.h \
    src/newsview/imagegallerydialog.h \
...
SOURCES += \
    ...
    src/feedsview/intelligentrefreshcalculator.cpp \
...
unix:!mac {
  ...
  DATA_DIR = $$PREFIX/share/quill
  DEFINES += RESOURCES_DIR='\\\"$${DATA_DIR}\\\"'

  target.path =  $$quote($$PREFIX/bin)

  desktop.files = quill.desktop
  desktop.path =  $$quote($$PREFIX/share/applications)

  target1.files = images/48x48/quill.png
  target1.path =  $$quote($$PREFIX/share/pixmaps)

  icon_16.files =  images/16x16/quill.png
  icon_32.files =  images/32x32/quill.png
  icon_48.files =  images/48x48/quill.png
  icon_64.files =  images/64x64/quill.png
  icon_128.files = images/128x128/quill.png
  icon_256.files = images/256x256/quill.png
